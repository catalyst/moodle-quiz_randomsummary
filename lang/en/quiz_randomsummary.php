...
/**
 * Strings for component 'quiz_randomsummary'
 *
...
$string['averageattempts'] = 'Average number of attempts';
$string['passedattempts'] = 'Passed attempts';
$string['failedattempts'] = 'Failed attempts';
$string['passedusers'] = 'Passed users';
$string['failedusers'] = 'Failed users';
